/****************************************************************************
**
** Namespace FidCOM generated by dumpcpp v5.11.1 using
...
public:
    ...
    */
    inline void SetAfterSessionComplete(qlonglong f);

    /*
    Method SetBeforeRequest
    */
    inline void SetBeforeRequest(qlonglong f);

    /*
    Method SetBeforeResponse
    */
    inline void SetBeforeResponse(qlonglong f);

    /*
    Method SetOnLogString
    */
    inline void SetOnLogString(qlonglong f);

    /*
    Method SetOnNotification
    */
    inline void SetOnNotification(qlonglong f);
...
public:
    ...
    : QAxObject(parent)
    {
        setControl(QStringLiteral("{31498642-c503-30e5-b8d5-289d79dffdfc}"));
    }
...
inline void IFidComClass::SetAfterSessionComplete(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 9, _a);
}

inline void IFidComClass::SetBeforeRequest(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 10, _a);
}

inline void IFidComClass::SetBeforeResponse(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 11, _a);
}

inline void IFidComClass::SetOnLogString(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 12, _a);
}

inline void IFidComClass::SetOnNotification(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
...
inline void FidCOMClass::SetAfterSessionComplete(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 12, _a);
}

inline void FidCOMClass::SetBeforeRequest(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 13, _a);
}

inline void FidCOMClass::SetBeforeResponse(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 14, _a);
}

inline void FidCOMClass::SetOnLogString(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 15, _a);
}

inline void FidCOMClass::SetOnNotification(qlonglong f)
{
    void *_a[] = {0, (void*)&f};
    qt_metacall(QMetaObject::InvokeMetaMethod, 16, _a);
}
