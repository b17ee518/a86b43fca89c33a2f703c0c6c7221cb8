...
void InfoMainWindow::updateFleetTable(int n, const QString& buttonTitle, int colindex, bool bRed, const QList<KQRowData>& rows)
{
	...
	{
		"QPushButton { color:white; text-align: left; }", // normal 0
		"QPushButton { color:rgb(153, 255, 255); text-align: left; }", // have kira 1
		"QPushButton { color:rgb(255, 255, 0); text-align: left; }", // kira full 2
		"QPushButton { color:rgb(60, 179, 113); text-align: left; }", // tokyu ok 3
		"QPushButton { color:rgb(102, 153, 255); text-align: left; }", // nezumi ok 4
		"QPushButton { color:rgb(255, 153, 0); text-align: left; }" // need hokyu 4
	};
...
void InfoMainWindow::updateTitle(const QString& title, int colindex)
{
	static QString stylesheet[] =
	{
		...
		"QLineEdit{ color: rgb(255, 255, 0); border: none; }",
		"QLineEdit{ color: rgb(255, 153, 0); border: none; }",
		"QLineEdit{ color: rgb(128, 128, 128); border: none; }",
		"QLineEdit{ color: rgb(153, 102, 0); border: none; }"
	};
