...
enum 
{
	...
	SLOTITEMTYPE_SIREIBU = 34,
	SLOTITEMTYPE_KOUKU_YOUIN = 35,
	SLOTITEMTYPE_KOUSYA = 36,
	SLOTITEMTYPE_TAICHI = 37,
	SLOTITEMTYPE_SYUHOU_L_II = 38,
	SLOTITEMTYPE_SUIJOU_YOUIN = 39,
	SLOTITEMTYPE_SONAR_L = 40,
	SLOTITEMTYPE_HIKOUTEI_L = 41,
};
