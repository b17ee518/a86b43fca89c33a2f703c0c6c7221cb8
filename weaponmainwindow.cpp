...
void WeaponMainWindow::setButtonColor(KQUI_CollapsibleFrame* pFrame, int colindex, bool bRed)
{
	...
	static QString stylesheet_a[] =
	{
		...
		"QPushButton { color:rgb(153, 255, 255); text-align: left; }", // have spare no lock
		"QPushButton { color:rgb(255, 255, 0); text-align: left; }", // all locked
		"QPushButton { color:rgb(255, 153, 0); text-align: left; }", // on but no lock
		"QPushButton { color:rgb(180, 180, 180); text-align: left; }" // no on
	};
